---
title: 'Prolific Calibration V323Fs 6pics - 2500ms analysis'
output:
github_document:
toc: yes
toc_float: yes
...
feature123_anova = aov(d_p~feature_index,filter(basicFeature,feature_index %in% c(1,2,3)))
summary(feature123_anova)

feature023_anova = aov(d_p~feature_index,filter(basicFeature,feature_index %in% c(0,2,3)))
summary(feature023_anova)
```
...
anovaFeature123_3rdRun = aov(d_p~feature_index,filter(basicFeature_run3,feature_index %in%c(1,2,3)))
summary(anovaFeature123_3rdRun)

anovaFeature023_3rdRun = aov(d_p~feature_index,filter(basicFeature_run3,feature_index %in%c(0,2,3)))
summary(anovaFeature023_3rdRun)
