...
#declare Bottemp3 = Index[clock][0]*0.017;          
...
//Feature02
#declare Bottemp4 = Index[clock][1]*0.01;
...
#declare top2 = Index[clock][2]*0.0155;
#declare top3 = Index[clock][2]*0.0155;


#declare top1_square_param_l=<-0.25,-0.05-top1,-0.05>;
#declare top1_square_param_r=<0.05+top1,0.22,0.27>;

#declare top2_square_param_l = <-0.2,-top1,-0.3>;
#declare top2_square_param_r = <0.3,0.1,+top2>;


#declare top3_square_param_l = <-top1,-0.25,-0.1>;
#declare top3_square_param_r = <0.3,+top3,0.25>;  
...
object{bottom_protrusion01 rotate<30,-25,-20> translate<0.3,0.7,0.5>}    
//object{bottom_protrusion02 rotate<0,-20,20> translate<0.2,0.5,0.4>} 
object{bottom_protrusion03 rotate<5,0,-30> translate<0.15,0.75,0.48>}//left up     
